...
var make_delete_task_use_case_exports = {};
__export(make_delete_task_use_case_exports, {
  makeDeleteUseCase: () => makeDeleteUseCase
});
module.exports = __toCommonJS(make_delete_task_use_case_exports);
