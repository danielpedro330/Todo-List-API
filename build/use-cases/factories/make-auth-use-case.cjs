...
var make_auth_use_case_exports = {};
__export(make_auth_use_case_exports, {
  makeAuthUseCase: () => makeAuthUseCase
});
module.exports = __toCommonJS(make_auth_use_case_exports);
