...
var make_search_task_use_case_exports = {};
__export(make_search_task_use_case_exports, {
  makeSearchTaskUseCase: () => makeSearchTaskUseCase
});
module.exports = __toCommonJS(make_search_task_use_case_exports);
